...
/**
 * This controller shows how to use token generated by UUID to implement security
 * In this demo, we need redis to act as in-memory storage which is used to store token for each user
 */
@Api(tags = {"LoginController"})
@RestController
@RequestMapping("/tuoke-web/api/tokens")
public class LoginUUIDController {
    private final Logger logger = LoggerFactory.getLogger(LoginUUIDController.class);
    @Autowired
